  ...
  const cursosData = [
    {
      ...
      subtitulo: 'Aprendé barbería desde cero',
      descripcion: 'Formación integral en técnicas de corte y afeitado',
      precio: 60000.0,
      duracion: '8 semanas',
      temario: [
        'Manejo de máquinas, trimmer y shaver',
        'Higiene y preparación del puesto de trabajo',
        'Técnicas de corte y degradados (fade)',
        'Corte clásico y moderno',
        'Atención y trato con el cliente',
      ],
      fechaInicio: new Date('2026-09-07'),
      fechaFin: new Date('2026-10-26'),
      diaCursada: ['Lunes'],
      horario: '19 a 22 hs',
      lugar: 'Sede Central',
      cupos: 10,
      inscripcionInicio: new Date('2026-08-01'),
      inscripcionHasta: new Date('2026-09-05'),
      requisitoImportante: 'Contar con modelo a partir de la 2da clase',
    },
    {
      nombre: 'Diseño de barba',
      subtitulo: 'Perfilado y diseño con navaja',
      descripcion: 'Técnicas de perfilado y diseño con navaja',
      precio: 35000.0,
      duracion: '4 semanas',
      temario: ['Perfilado y diseño de barba', 'Manejo de navaja', 'Eliminación de líneas y transiciones', 'Técnicas de terminación'],
      fechaInicio: new Date('2026-09-14'),
      fechaFin: new Date('2026-10-05'),
      diaCursada: ['Martes', 'Jueves'],
      horario: '18 a 20 hs',
      lugar: 'Sede Central',
      cupos: 8,
      inscripcionInicio: new Date('2026-08-01'),
      inscripcionHasta: new Date('2026-09-10'),
      requisitoImportante: 'Contar con modelo a partir de la 2da clase',
    },
    {
      nombre: 'Coloración masculina',
      subtitulo: 'Color y mechas para cabello corto',
      descripcion: 'Coloración y mechas para cabello corto',
      precio: 45000.0,
      duracion: '6 semanas',
      temario: ['Tipos de coloración y decolorantes', 'Técnicas de mechas', 'Cuidado post-color', 'Corrección de color'],
      fechaInicio: new Date('2026-09-21'),
      fechaFin: new Date('2026-11-02'),
      diaCursada: ['Miércoles'],
      horario: '19 a 21 hs',
      lugar: 'Sede Central',
      cupos: 6,
      inscripcionInicio: new Date('2026-08-01'),
      inscripcionHasta: new Date('2026-09-15'),
      requisitoImportante: 'Contar con modelo a partir de la 2da clase',
    },
  ];
